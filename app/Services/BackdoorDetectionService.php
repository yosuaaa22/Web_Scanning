...
class BackdoorDetectionService
{
    ...
    private function generateRiskDescription($riskMetrics)
    {
        $description = [];

        foreach ($riskMetrics['category_breakdown'] as $category => $findings) {
            $description[] = "Category: $category, Findings: " . count($findings);
        }
