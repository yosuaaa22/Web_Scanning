...
<body class="min-h-screen p-8">
    <div class="container mx-auto max-w-6xl">
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="space-x-4">
                <form action="{{ route('scanner.history.download') }}" method="GET" class="inline">
                    <select name="date" class="px-4 py-2 bg-gray-800 rounded-lg text-cyan-300">
                        <option value="">Cetak Semua</option>
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="table-row-hover border-t border-gray-800">
                        ...
                        <!-- Karena scan_time sudah di-cast ke datetime, method format() dapat dipanggil -->
