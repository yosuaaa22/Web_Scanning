...
<body class="page-container">
    ...
    <div class="min-h-screen p-8 container mx-auto max-w-6xl">

        <!-- Neon Line Effect -->

        <div class="neon-line w-full top-20"></div>
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <h1 class="text-4xl font-bold">
                ...
                <i class="fas fa-history mr-3 text-cyan-400"></i>
            ...
            <div class="flex items-center space-x-4">
                ...
                <form action="{{ route('scanner.history.download') }}" method="GET" class="flex items-center space-x-2">

                    <select name="date" class="px-4 py-2 bg-gray-800 rounded-lg text-cyan-300 border border-cyan-600">
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-t border-gray-700 hover:bg-gray-800 transition-colors">
                        ...
                        <td class="p-4 risk-{{ strtolower($result->backdoor_risk) }}">

                            {{ $result->backdoor_risk }}

                        </td>

                        <td class="p-4 risk-{{ strtolower($result->gambling_risk) }}">
