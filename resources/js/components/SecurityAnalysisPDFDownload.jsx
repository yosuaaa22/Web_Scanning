...
const SecurityAnalysisPDF = ({ details }) => (
  <Document>
...
const SecurityAnalysisPDFDownload = ({ backdoorResult }) => {
  if (!backdoorResult?.details) {
    return <Text>No data available for PDF generation</Text>;
  }

  return (
    <PDFDownloadLink
      document={<SecurityAnalysisPDF details={backdoorResult.details} />}
      fileName="security-analysis.pdf"
    >
      {({ loading }) => (
        <Button 
...
export default SecurityAnalysisPDFDownload;